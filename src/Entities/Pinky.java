...
public class Pinky extends Entity{
    ...
    private ImageIcon pSprite;                  //--main-sprite
    ...
    public Pinky(PacMan pacMan, ImageIcon sprite, int rowPos, int colPos, Model model, int maxRow, int maxCol) {
        this.pacMan = pacMan;
    ...
    public void move() {
        ...
        switch (dm) {
            ...
            default -> {
                model.setValue(new Tile(pSprite, Color.BLACK), rowPos, colPos);
                return;
            }
        }
        ...
        if (nextRow == pacRow && nextCol == pacCol) {
            if (hit == true) {
                PacMan.lose_st_HP();
                System.out.println("[DEBUG] Entities.Pinky: Hit | HP: " + PacMan.get_st_HP());
                hit = false;
            }
        }
        ...
        model.setValue(keepPrev, rowPos, colPos);
        model.setValue(new Tile(pSprite, Color.BLACK), nextRow, nextCol);
